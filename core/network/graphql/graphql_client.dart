...
import 'package:Appapp/services/core/components/network/rest/interceptors/request_logging_interceptor.dart';
...
abstract class GraphQLClient extends AppModule {
...
class GraphQLClientImpl extends GraphQLClient {
  ...
  AppLogger get _logger => AppCore.instance.logger;
