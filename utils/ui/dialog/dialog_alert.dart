...
import 'package:Appapp/ui/widgets/dialog/alert_dialog_route.dart';
import 'package:Appapp/ui/widgets/typography/App_styled_text.dart';
...
class LoadingAlert extends StatelessWidget {
  ...
  const LoadingAlert({required this.message, this.title});
