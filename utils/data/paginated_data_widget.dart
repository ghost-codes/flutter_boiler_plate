import 'package:Appapp/redesign/ui/widgets/data/data_widget.dart';
import 'package:Appapp/redesign/ui/widgets/placeholders/App_empty_widget.dart';
import 'package:Appapp/services/core/App_core.dart';
import 'package:Appapp/ui/widgets/loading/loader_view.dart';
import 'package:Appapp/ui/widgets/refresh_wrapper.dart';
        ...
        body: Column(
          children: [
            ...
            if (loading && !_refreshing) ...[
              ...
              const AppCircularProgress(size: 50),
              const SizedBox(height: 16),
            ]
          ],
        ),
